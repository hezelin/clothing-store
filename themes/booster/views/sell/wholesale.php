    ...
    <?php foreach($item as $color=>$row){ ?>
        <div class="form-group">
            ...
            <div class="col-sm-3">
                <!-- 按手 -->
                <div class="input-group whole-sale">
                    <input class="form-control" placeholder="一件售价" name="TblSell[whole][<?php echo $color;?>][sell]"  type="text" />
                    <span class="input-group-addon">元</span>
                </div>
                <!-- 按件 -->
                <?php foreach($row['data'] as $r){ ?>
                <div class="input-group one-sale">
                    <input class="form-control" placeholder="一件售价" name="TblSell[item][<?php echo $r['item_id'];?>][sell]"  type="text" />
                    <span class="input-group-addon">元</span>
                </div>
                <?php }?>
            </div>
